...
Your assigned company: Boston Scientific (BSX), CIK 0000885725.

Fetch https://data.sec.gov/api/xbrl/companyconcept/CIK0000885725/dei/EntityCommonStockSharesOutstanding.json (set a descriptive User-Agent per SEC guidance).
...
`{"entityName": "Boston Scientific", "max": {"val": ..., "fy": ...}, "min": {"val": ..., "fy": ...}}`
